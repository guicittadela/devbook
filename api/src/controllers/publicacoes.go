...
func CriarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	ID, erro := repositorio.Criar(publicacao)
	if erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
	}
	publicacao.ID = ID
...
func BuscarPublicacoes(w http.ResponseWriter, r *http.Request) {
	ID, erro := autenticacao.ExtrairUsuarioID(r)
	if erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, erro)
		return
	}
	...
	repositorio := repositorios.NovoRepositorioPublicacao(db)
	publicacoes, erro := repositorio.BuscarPublicacoes(ID)
	if erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
...
func BuscarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	defer db.Close()
	repositorio := repositorios.NovoRepositorioPublicacao(db)
	publicacao, erro := repositorio.BuscarPublicacao(ID)
...
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.NovoRepositorioPublicacao(db)
	publicacaoSalva, erro := repositorio.BuscarPublicacao(publicacaoID)
	if erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
	...
	if publicacaoSalva.AutorID != usuarioID {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("erro"))
		return
	}
...
func BuscarPublicacaoPorUsuario(w http.ResponseWriter, r *http.Request) {
	...
	publicacoes, erro := repositorio.BuscarPorUsuario(ID)
